...
const WelcomeSection = () => {
    ...
    <section className="homepage__welcome" aria-labelledby="welcome-title">
      <motion.div
        ...
        <h2 id="welcome-title" className="txt-white">
          Welcome to <strong>PAPA JES’S PIZZAHOUSE</strong> restaurant
        </h2>
        <p>
          ...
          corporate parties! At PAPA JES’S PIZZAHOUSE we care about you because you are the
  ...
  alt="PAPA JES’S PIZZAHOUSE restaurant interior with people at the table and the staff serving the customers"
      />
    </section>
  );
};

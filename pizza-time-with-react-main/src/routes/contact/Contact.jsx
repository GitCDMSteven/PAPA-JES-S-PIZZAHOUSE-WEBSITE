...
// reCAPTCHA removed from Contact page (handled optionally elsewhere)
...
const Contact = () => {
  ...
  useEffect(() => {
  document.title = "Contact | PAPA JES’S PIZZAHOUSE";
    // Debug mount/unmount to help diagnose flashing/unmount issues
